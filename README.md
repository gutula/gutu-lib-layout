...
| Primary focus | layout primitives, responsive structure, shared composition |
...
| Named Exports | 6 | `packageId`, `packageDisplayName`, `packageDescription`, `WorkspaceShellLayout`, `DashboardGrid`, `SplitPanelLayout` |
...
console.log(packageId, packageDisplayName, typeof WorkspaceShellLayout);
```

Use the root repo scripts for day-to-day work after the workspace is bootstrapped, or run the nested package directly from `framework/libraries/layout` if you need lower-level control.
